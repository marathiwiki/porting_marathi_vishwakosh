 ...
 *  @version 0.31
 */
public class WikiLibrary implements Serializable
{
    // Master TODO list:
    // *Admin stuff
    // *More multiqueries
     ...
     *  en.wikipedia.org)
     */
    public WikiLibrary(String domain)
    {
        this(domain, "/w");
    }
     ...
     *  @since 0.14
     */
    public WikiLibrary(String domain, String scriptPath)
    {
     ...
     *  @since 0.31
     */
    public WikiLibrary(String domain, String scriptPath, String protocol)
    {
...
//        apigen.append("/api.php?format=xml&");
    ...
    {
        if (!(obj instanceof WikiLibrary))
            return false;
        return domain.equals(((WikiLibrary)obj).domain);
    }
    ...
    protected void populateNamespaceCache() throws IOException
    {
        ...
        namespaces = new LinkedHashMap<String, Integer>(30);
    ...
    public String[] getTemplates(String title, int... ns) throws IOException
    {
        ...
        List<String> templates = new ArrayList<String>(750);
    ...
    public class User implements Cloneable, Serializable
    {
        ...
        {
            return WikiLibrary.this.contribs(username, ns);
        }
    ...
    public class LogEntry implements Comparable<LogEntry>
    {
         ...
         */
        @Override
        public int compareTo(WikiLibrary.LogEntry other)
        {
    ...
    public class Revision implements Comparable<Revision>
    {
        ...
        public int hashCode()
        {
            return (int)revid * 2 - WikiLibrary.this.hashCode();
        }
         ...
         */
        @Override
        public int compareTo(WikiLibrary.Revision other)
        {
            if (timestamp.equals(other.timestamp))
                return 0; // might not happen, but
            return timestamp.after(other.timestamp) ? 1 : -1;
        ...
        {
            WikiLibrary.this.rollback(this, false, "");
        }
        ...
        {
            WikiLibrary.this.rollback(this, bot, reason);
        }
    }
